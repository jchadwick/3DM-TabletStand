...
| USB-C | Center of right short edge from the front. The rear-floor turn opening remains **16 mm wide × 8 mm deep**, but is shifted **4.0 mm inboard** across the tablet edge: 4.0 mm lies inboard and 4.0 mm outboard. The former outboard 4 mm is restored floor, while the full 8.0 mm-deep plug chamber above it and the solid outer wall/cap remain unchanged |
...
| Current status | The physical coupon passed: the production tongue and receiver fit, and the corrected wedge/pin retained and released successfully. Retain the 0.50 mm root / 1.10 mm lead clearances. The corrected full-span right-wing print was very stringy, but the tablet slid in smoothly and fit snugly with very good clearance; preserve the 1.0/0.8 mm allowance. That print exposed the tablet's rounded front corners and excessive outboard rear-floor USB opening. The screen opening now has 5.3 mm corner curves with 1.7 mm nominal overlap, and the unchanged 16 × 8 mm USB rear-floor opening is shifted 4 mm inboard while preserving the plug chamber. Both revisions are CAD-validated but not physically tested, and all earlier right-wing G-code is stale. The left wing and remaining parts are not yet authorized |
