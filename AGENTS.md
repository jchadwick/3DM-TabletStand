...
| Current status | The physical coupon passed: the production tongue and receiver fit, and the corrected wedge/pin retained and released successfully. Retain the 0.50 mm root / 1.10 mm lead clearances. The corrected full-span right-wing print was very stringy, but the tablet slid in smoothly and fit snugly with very good clearance; preserve the 1.0/0.8 mm allowance. The screen opening has 5.3 mm corner curves with 1.7 mm overlap, the USB rear-floor opening is 16 × 12 mm, and V3 retains its 1.30/0.90 mm finish. The latest quality pass replaces the visually ridged stacked front pieces with one smooth ring, closes the superseded left entry lead, and extends the concealed button channel through the complete left-wing slide path. All post-print geometry changes are CAD-validated but not physically tested; all earlier right-wing G-code is stale, and the left wing and remaining parts are not authorized |
