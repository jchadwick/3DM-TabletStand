...
| Outside finish | Front-frame opening follows the supplied tablet's approximately **7.0 mm** plan corner radius, with a **17.0 mm** outer frame radius for a uniform 10 mm frame wall; rails/walls use 1.45 mm plan corners and 0.70 mm edge fillets, lips use 1.05 mm plan corners and 0.60 mm edge fillets, and the integral left closure retains a 1.70 mm plan corner and 0.85 mm edge fillet |
