...
| Current status | The physical coupon passed: the production tongue and receiver fit, and the corrected wedge/pin retained and released successfully. On 2026-08-27 the user reported that all current production parts printed well and fit great. Retain the 0.50 mm root / 1.10 mm lead clearances and 1.0/0.8 mm tablet allowance. The screen opening has 5.3 mm corner curves with 1.7 mm overlap, the USB rear-floor opening is 16 × 12 mm, and V3 retains its 1.30/0.90 mm finish, smooth unified front ring, closed left entry lead, and full-travel concealed button channel. Permanent assembly still requires adhesive bonds from the fixed right wing to the rear bracket and from the bracket to the sleeve; use the single alignment key only in the latter joint and keep the removable left wing adhesive-free |
