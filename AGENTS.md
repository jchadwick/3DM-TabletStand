...
| Cable | Right-angle pigtail is photo-marked 51.4 mm long; its 0.6 mm flat section and downstream connection stay behind the tablet, then the confirmed 3.45 mm round braided cable routes through one open 12 mm rear clip/channel to the sleeve |
...
| Clip-to-channel route | The inaccessible inner X = 16 mm clip is removed. One 12 mm-long open clip/channel occupies the former outer-clip region from X = 25–37 mm, clear of the center gusset. The free cable span drops outside the right gusset, sweeps behind the sleeve, and enters the channel through its rear opening—never route previewed cable through solids |
| V2 module split (historical geometry basis) | Flat-print cradle, foot-down rear tilt bracket, and flange-down/bore-up sleeve. V3 preserves the installed bracket/sleeve geometry while its replacement bracket print orientation is now broad bond-plate down with the cable channel up |
...
| Rear clip ownership | One open 12 mm braided-cable clip/channel is on the rear tilt bracket so the cradle retains a complete flat rear print datum |
...
| V3 bracket attachment | Rear bracket bonds only to the fixed right cradle wing; do not glue it to the removable left wing. The bracket-to-sleeve bond retains one 35 × 15 × 1.8 mm alignment key (`alignment_key` STL quantity 1). The active V3 bracket STL prints on its broad cradle-bond plate with the cable clip opening upward |
...
| Button clearance | Power/volume group is **20–60 mm from landscape top-left**, **2 mm wide across tablet thickness**, centered, and **1 mm protruding**. The active V3 concealed inner groove is **2 mm high × 1.2 mm deep** and runs along the complete removable left-wing travel from **X = −103.5 mm to the center seam**, with a 0.2 mm cutter overrun; it preserves a solid **1.8 mm exterior rail wall**, the retaining perimeter, and the closed left outer wall |
| Outside finish | The rear frame opening follows the supplied tablet's approximately **7.0 mm** plan corner radius, with a pronounced **28.0 mm** outer frame radius. The entire screen-facing perimeter is now **one continuous CadQuery ring** spanning both long rails and both integral short closures; it is split only by the flush 0.35 mm removable-wing seam. There are no stacked V2 lips, separate left/right caps, corner-bezel overlays, or coplanar shroud faces. Its **196.6 × 119.6 mm** tablet-concentric opening retains **5.3 mm** corners and **1.7 mm nominal overlap**. The obsolete 4 mm left end-stop rail lead is closed with a hidden 0.2 mm rail-to-closure overlap. Rear shrouds stop below and fuse inside the front ring, so joiners stay hidden without visible ridges. V3 retains 1.45 mm rail/wall, 1.05 mm lip, and 1.70 mm left-closure plan corners, plus **1.30 mm** front/exposed fillets on 3.0 mm rails/walls and **0.90 mm** on the 2.0 mm ring; rear print datums remain flat. Fit surfaces, joints, screen edge, and cable interfaces are unchanged; historical V2 keeps its 0.70/0.60 mm edge fillets |
...
| Current status | The physical coupon passed: the production tongue and receiver fit, and the corrected wedge/pin retained and released successfully. On 2026-08-27 the user reported that all current production parts printed well and fit great. Retain the 0.50 mm root / 1.10 mm lead clearances and 1.0/0.8 mm tablet allowance. The screen opening has 5.3 mm corner curves with 1.7 mm overlap, the USB rear-floor opening is 16 × 12 mm, and V3 retains its 1.30/0.90 mm finish, smooth unified front ring, closed left entry lead, and full-travel concealed button channel. The replacement bracket with one accessible 12 mm outer clip/channel was started clips-up on 2026-08-27 using the validated functional PLA slice; completion and physical clip fit remain to be confirmed. Permanent assembly still requires adhesive bonds from the fixed right wing to the rear bracket and from the bracket to the sleeve; use the single alignment key only in the latter joint and keep the removable left wing adhesive-free |
