...
| Current status | The physical coupon passed: the production tongue and receiver fit, and the corrected wedge/pin retained and released successfully. Retain the 0.50 mm root / 1.10 mm lead clearances. The corrected full-span right-wing print was very stringy, but the tablet slid in smoothly and fit snugly with very good clearance; preserve the 1.0/0.8 mm allowance. That print exposed the tablet's rounded front corners, so the screen opening now has 5.3 mm corner curves with 1.7 mm nominal overlap. This corner revision is CAD-validated but not physically tested, and all earlier right-wing G-code is stale. The left wing and remaining parts are not yet authorized |
