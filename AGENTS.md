...
| Current status | The 2026-08-10 physical coupon had major bed-adhesion/stringing defects, but the production tongue and receiver still fit together; retain their 0.50 mm root / 1.10 mm lead clearances. The wedge/pin body began about 1.65 mm above the bed because its larger pull head set the datum, so the support-free wedge layout failed and its G-code is stale. Redesign the wedge with a common flat datum or use removable support before any production print; retention strength is not yet confirmed. No full V3 part is authorized |
