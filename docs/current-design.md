...
- Previous full-cradle, end-stop, and combined V3 coupon G-code is stale. Do not print it. The tongue/receiver fit and wedge retention gates passed. The right-wing production job is active; do not start the left wing or other parts until their fresh slices and support/adhesion review are complete.
