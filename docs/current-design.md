...
| Exposed finish | Rear frame opening follows the supplied tablet's approximately 7.0 mm plan corner radius; outer frame radius is 28.0 mm. The screen-facing opening is 196.6 × 119.6 mm with 5.3 mm tablet-concentric corners and 1.7 mm nominal overlap over the tablet's 7 mm corners. Continuous top/bottom edge rails shroud the rear joiners while keeping the screen-facing perimeter straight. V3 keeps the 1.45 mm rail/wall and 1.05 mm lip plan corners, but now uses continuous 1.30 mm cross-sectional fillets around the 3.0 mm rear perimeter, long rails, and short outer walls, plus 0.90 mm fillets on 2.0 mm lips/caps; their 0.40/0.20 mm center lands prevent knife edges | Conceals the physically visible tablet corners, strongly softens the complete exterior perimeter, and preserves the sharp approved screen opening and successful cavity fit below the front lip plane |
...
- The rear frame opening follows the supplied tablet mesh's approximately 7 mm corner curve, and the outer frame plan radius remains 28 mm. V3 adds a distinct cross-sectional treatment around the complete exterior: 1.30 mm fillets run along the 3.0 mm rear perimeter, both long rail walls, and both full-span short outer walls, while the 2.0 mm screen-facing lips/caps use 0.90 mm fillets. The remaining 0.40/0.20 mm center lands prevent fragile knife edges. At the front lip plane, the four corner infills still form a sharp-edged 196.6 × 119.6 mm rounded screen opening: its 5.3 mm radius is concentric with the tablet's approximately 7 mm radius and leaves the proven 1.7 mm straight-edge overlap. The infills hide the tablet glass/body corners while leaving the insertion cavity below them unchanged. Continuous top/bottom edge rails absorb the joiner blocks on the rear so the screen-facing perimeter and its stronger rounding remain uninterrupted across the center split. V3 has no vestigial screw-era projection below the left corner.
...
- Previous full-cradle, end-stop, combined V3 coupon, and all right-wing G-code files are stale for the current corner-covered and strongly filleted geometry and have been removed from the active tree. Do not restore or print them; Git history retains them as process evidence. The tongue/receiver fit and wedge retention gates passed. The corrected full-span right-wing job completed from the prior geometry using rear-face-down, 0.16 mm layers, 3 walls, 20% grid infill, 55° snug build-plate-only supports, a 0.24 mm Z gap, 0.70 mm XY gap, 3 interface layers, and a 5 mm brim. The result was very stringy, but the tablet slid in very smoothly and fit snugly with very good clearance. Preserve that cavity fit. Its visible tablet corners prompted the 5.3 mm front-opening corner revision, and the exterior is now continuously rounded with 1.30/0.90 mm edge fillets; neither finish change is physically tested. A fresh slice and physical confirmation are required before another right-wing print. Do not start the left wing or other parts without separate authorization.
