...
The project is a simple, sleek, FDM-printable landscape holder for a 2024 onn. 8-inch tablet. It mounts permanently to the accessible top end of a vertical 32 mm OD tube. V3 is the active split-cradle design: its physical tongue/receiver coupon fit, the corrected wedge retained and released successfully, and on 2026-08-27 the user reported that all production parts printed well and fit great. V3 preserves the tested tablet, button, USB-C, tube, and cable interfaces while replacing both the 215 mm-wide cradle print and separate left cap with two bed-friendly wings. Permanent adhesive assembly uses the rear tilt bracket between the fixed right wing and sleeve as illustrated in [`assembly.md`](assembly.md). Superseded V1 is archived only in Git history at commit `560c6e8` and is not maintained.
...
| Rear cable opening | 16 × 12 mm (Y × X): 4 mm inboard + the original full 8 mm outboard span | Photo-requested enlargement adds the green-marked tablet-side area without filling any of the original opening; the plug chamber above remains 8 mm deep |
...
| Top button channel | Concealed internal groove, 2 mm high × 1.2 mm deep; active V3 span X = −103.5 mm to the center seam, with 0.2 mm cutter overrun | Clears the 1 mm button projection over the complete removable left-wing slide path while preserving a solid 1.8 mm exterior rail wall, retaining perimeter, and closed left outer wall |
| Rear bracket cable clip/channel | One 12 mm-long open C-channel, X = 25–37 mm; 4.15 mm ID / 2.8 mm snap opening | Replaces two 6 mm clips; removes the inaccessible inner X = 16 mm clip while preserving total cable contact length and clearing the center gusset |
| Braided-cable sleeve channel | 4.15 mm ID / 2.8 mm snap opening | 0.70 mm total clearance around confirmed cable diameter |
| Sleeve channel embed / remaining wall | 1.2 mm / 2.8 mm minimum | Keeps the 32.2 mm tube bore intact |
| Exposed finish | Rear frame opening follows the tablet's approximately 7.0 mm plan corner radius; outer rear-frame radius is 28.0 mm. One continuous screen-facing ring now supplies all four visible rails/closures and is interrupted only by the flush 0.35 mm wing split—there are no stacked lips, end caps, bezel overlays, or coplanar shroud faces. Its opening remains 196.6 × 119.6 mm with 5.3 mm tablet-concentric corners and 1.7 mm overlap. V3 keeps 1.45 mm rail/wall, 1.05 mm lip, and 1.70 mm left-closure plan corners, with 1.30 mm front/exposed rail/wall fillets and 0.90 mm ring fillets; rear print datums remain flat | Removes visible ridges and superseded slider/end-stop remnants while preserving the approved screen edge, cavity fit, insertion path, and rear-face-down layout |
...
| V3 cradle split | Left wing 125.00 × 139.00 × 14.20 mm; right wing 111.33 × 139.00 × 14.20 mm | Replaces the 215 mm-wide single cradle print; the one-piece front ring and buried rear shrouds absorb the outer joiner blocks without visible ridges; both wings remain rear-face-down and fit comfortably on the 220 mm bed |
...
- The left wing has a continuous rounded wall with no separate cap or visible entry step. The obsolete 4 mm V2 end-stop rail lead is closed; each long rail overlaps the integral closure by 0.20 mm behind the visible face. One screen-facing ring spans the complete 139 mm envelope and both wings, leaving only the flush center split. The right wing retains the tested USB-C housing. Its rear-floor opening keeps the complete original 8 mm outboard span and adds 4 mm inboard: the 16 × 12 mm opening runs from X = 96.5–108.5 mm across the fitted tablet edge at X = 100.5 mm. All V2 cap-specific tapered plugs, sockets, receiver bulges, lip overlays, and slider-looking remnants are absent from V3.
...
- The cradle prints with its complete rear frame datum on the bed. The cable clip/channel is on the rear bracket. The previous end-stop screw boss and pilot are removed.
- The rear bracket's 74 × 36 mm tilted plate bonds to the matching upper region of the cradle center plate. The active V3 production STL prints on that broad bond plate with its open cable channel facing upward; this supersedes the old V2 foot-down production orientation for the replacement bracket.
...
- The landscape-top rail has a concealed 2 mm-high × 1.2 mm-deep groove in its inner face, centered on the tablet's thickness. In active V3 it runs continuously from the integral closure-side rail interior at X = −103.5 mm to the center seam, with only a 0.20 mm cutter overrun past the split for a clean edge. This clears the buttons during the entire +X left-wing slide, not only at their seated position. The groove does not cut the left outer closure or exterior face: a solid 1.8 mm outer wall and the complete screen-facing ring remain.
- The single continuous screen-facing ring covers the right side from the tablet edge to the solid outer wall; two internal stop walls beneath it locate the tablet while accommodating the 6.50 mm-projecting USB-C plug. The ring remains structurally continuous because the cable opening is in the rear pocket floor, not through the visible face.
...
- The right side presents a continuous enclosed screen-facing face: the outer wall and full-depth cap span the complete 139 mm V3 perimeter, including the extended top/bottom corners. The plug chamber remains open toward the tablet cavity and keeps its full 8 mm depth above the rear floor for the recorded 6.50 mm projection. The rear-floor opening is enlarged from its original 16 × 8 mm area by adding the green-marked 4 mm inboard relief, producing a 16 × 12 mm opening. None of the original outboard opening is filled or removed.
- The 3.45 mm braided section snaps into one 12 mm-long open C-channel on the rear bracket. The channel spans X = 25–37 mm in the former outer-clip region; the crowded inner X = 16 mm clip is removed. From the channel it drops through open space outside the right gusset, sweeps behind the sleeve, and enters the rear-facing external sleeve channel through its snap opening. No segment passes through a holder, gusset, or sleeve solid, and the 9.6 mm-marked connector body remains accessible outside all captive features.
...
- The rear frame opening follows the supplied tablet mesh's approximately 7 mm corner curve, and the outer rear-frame plan radius remains 28 mm. The visible front is now authored as one asymmetric ring rather than a union of separately pre-filleted V2 lips, left/right caps, corner infills, and full-height shrouds. It keeps the established 1.70 mm outer short-edge plan corner and 0.90 mm cross-sectional fillet while cutting the same sharp-edged 196.6 × 119.6 mm opening with 5.3 mm corners and 1.7 mm tablet overlap. The 1.30 mm long-wall and short-wall finish remains on exposed/front edges; the rear-side wall edges stay flat where required for a complete watertight print datum. Two rear shrouds stop 0.70 mm below the front face and fuse inside the ring, hiding joiner blocks without a coplanar ridge. The left and right wing colors meet only at the unavoidable 0.35 mm center split, and V3 has no end-stop, slider, cap, or screw-era surface remnant.
...
- Before another full right wing, print or otherwise physically verify the revised right-side USB region rear-face down in the intended PLA process. Slide the tablet's right edge through the production rails, seat it against the internal stops, connect the real USB-C adapter, and confirm that the complete thick cable section turns through the enlarged 16 × 12 mm rear rectangle without pinching or forcing the tablet. The prior physical wing proves tablet fit, not this enlarged floor opening.
...
- The first `tablet_stand_v3_lock_coupon_all3.stl` print physically passed tongue/receiver fit despite severe adhesion and stringing. The corrected pin then retained and released successfully. Do not rescale or change the confirmed tongue/socket clearances. The stale combined coupon G-code and pre-finish right-wing slices remain recoverable from Git history. The prior right-wing production job used snug 45° supports and a 5 mm brim and completed on 2026-08-10; on 2026-08-27 the user reported that all current production parts printed well and fit great.

## Current print status

- The replacement rear bracket uses one 12 mm outer cable channel and the active V3 broad-plate-down, channel-up orientation. Its functional PLA slice uses 0.20 mm layers, five walls, 40% grid infill, no supports, and no brim; validation passed at 7.5 mm³/s peak flow with an estimated 1 h 31 m / 22.4 g.
- The user explicitly authorized the print. A fresh full-bed camera snapshot showed an empty plate, and Moonraker accepted the job at 2026-08-27 04:48:05 UTC. Completion and physical cable insertion remain to be confirmed.
...
- Previous full-cradle, end-stop, and combined V3 coupon G-code files are stale for the current geometry; Git history retains them as process evidence. The tongue/receiver fit and wedge retention gates passed. The corrected full-span right-wing job completed from prior geometry using rear-face-down, 0.16 mm layers, 3 walls, 20% grid infill, 55° snug build-plate-only supports, a 0.24 mm Z gap, 0.70 mm XY gap, 3 interface layers, and a 5 mm brim. That print was very stringy, but the tablet slid in smoothly and fit snugly. On 2026-08-27 the user subsequently confirmed that all current production parts printed well and fit great. Preserve the active cavity and joint dimensions for any reprint.
