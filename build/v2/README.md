...
Each structural glue joint uses one 36 × 16 × 2 mm cross key. The mating parts
have 1.15 mm-deep clearance grooves, leaving 0.30 mm total depth for adhesive
and print variation.
...
All five exported STL files are single watertight solids. The alignment-key STL
is printed twice. The cradle has a broad 216 × 137.5 mm rear datum, the bracket
has a 60 × 28 mm foot, and the sleeve has a 60 × 46 mm flange. The split removes
the V1 tall rail-support towers and the support ceiling inside the sleeve bore.
